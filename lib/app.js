...
select.addEventListener("change", () => {
    ...
    switch (op) {
      ...
      `;
        ...
        // Ausgabe: inhalt  (Konsole)
        case "ausgabe_konsole":
            operatorForm.innerHTML = `
        <label>
          Inhalt (JS-Ausdruck):
          <input id="outText" type="text"
      ...
      <label>
        ...
        <label style="margin-left:20px;">
          <input type="radio" name="outType" value="alert"> Meldungsfenster
        </label>
      </label>
...
function updatePreview() {
    ...
    switch (op) {
        ...
        case "ausgabe_konsole": {
            const expr =
                (document.getElementById("outText")?.value || '"Hallo Welt"').trim() ||
                '"Hallo Welt"';
